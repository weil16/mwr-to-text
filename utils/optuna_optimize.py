...
def objective(trial):
    ...
    config["training"]["epochs"] = trial.suggest_int("epochs", 5, 20)
    ...
    # Loss weights
    config["model"]["loss_weights"]["generation"] = trial.suggest_float("gen_weight", 0.3, 0.7)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--study-name", type=str, default=None, help="Custom name for the study")
